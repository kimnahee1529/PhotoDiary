...
private val primary = Color(0xFFFFD344)
...
sealed class ColorSet {
    open lateinit var lightColors: ExampleColor
    open lateinit var darkColors: ExampleColor

    data object Lucky : ColorSet() {
        override var lightColors = ExampleColor(
        ...
        override var darkColors = ExampleColor(
